            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  We help businesses leverage the power of Artificial Intelligence and automation tools (like LLMs and n8n) to streamline operations, boost productivity, and drive growth.
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  ...
                  <li>
                    <Link
                      href="/about"
                      className="rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark"
                    >
                      Learn More About Us
                    </Link>
                  </li>
                ...
                <div>
                  <p className="mb-10 text-center text-base font-medium text-white/60">
                    Leveraging cutting-edge AI and automation technology
                  </p>
                  <div
