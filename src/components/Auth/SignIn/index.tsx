...
const Signin = () => {
  ...
  const loginUser = (e: any) => {
    ...
    setLoading(true);
    // signIn("credentials", { ...loginData, redirect: false }) // Removed auth
    //   .then((callback) => {
    //     if (callback?.error) {
    ...
    // Since signIn is removed, just stop loading and show an error/message
    setLoading(false);
    toast.error("Sign in functionality is currently disabled.");
  };
