    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          title="Your AI & Automation Queries Answered"
          paragraph="Find answers to common questions about our AI and automation services and how they can benefit your business."
          width="640px"
          center
        />

        <div className="mx-auto mt-12 max-w-[770px] lg:mt-20">
          {/* Removed the two-column layout wrapper */}
            <SingleFaq
              question="What kind of AI solutions do you offer?"
              answer="We offer custom AI model development, AI agent creation, data analysis, and AI strategy consulting tailored to your specific business needs."
            />
            <SingleFaq
              question="How does workflow automation benefit my business?"
              answer="Automation streamlines repetitive tasks, reduces errors, improves efficiency, and frees up your team to focus on higher-value activities. We specialize in platforms like n8n."
            />
            <SingleFaq
              question="What industries do you serve?"
              answer="Our AI and automation solutions are adaptable to various industries, including e-commerce, marketing, finance, operations, and customer service. We focus on the underlying business processes."
            />
          {/* Removed the closing div for the first column and the opening div for the second column */}
            <SingleFaq
              question="How long does it take to see results?"
              answer="Timelines vary depending on project complexity, but many automation projects show tangible benefits within weeks. AI projects may have longer R&D phases but offer significant long-term advantages."
            />
        {/* Removed the closing div for the second column */}
        </div>
      </div>
